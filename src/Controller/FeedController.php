...
class FeedController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $entityManager, MailService $mailService, ValidatorInterface $validator, Recaptcha3Validator $recaptcha3Validator): Response
    {
        $feed = new Feed();
